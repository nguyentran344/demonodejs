...
function buildItem(element) {
  let { name, start_date, end_date, description } = element;
  return `
...
function buildItem2(element) {
  let { name, start_date, end_date, description } = element;
  return `
          <div class="w3-container">
          <h5 class="w3-opacity"><b>${name}</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>${start_date} - ${end_date}</h6>
          <p>${description}</p>
          <hr>
        </div>`;
}
